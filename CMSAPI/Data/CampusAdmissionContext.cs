...
public partial class CampusAdmissionContext : DbContext
{
    public CampusAdmissionContext(DbContextOptions<CampusAdmissionContext> options)
        : base(options)
    {
    }
    ...
    public virtual DbSet<vw_StudentDistribution> vw_StudentDistributions { get; set; }

    public virtual DbSet<vw_StudentTransport> vw_StudentTransports { get; set; }

    public virtual DbSet<vw_TransportRoute> vw_TransportRoutes { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<vw_StudentDistribution>(entity =>
        {
            entity
                .HasNoKey()
        ...
        modelBuilder.Entity<vw_StudentTransport>(entity =>
        {
            entity
                .HasNoKey()
        ...
        modelBuilder.Entity<vw_TransportRoute>(entity =>
        {
            entity
                .HasNoKey()
